...
import com.vishesh.workoutapp.databinding.ItemExerciseStatusBinding
        ...
        when{
            model.getIsSelected() ->{
                holder.tvItem.background =
                    ...
                    R.drawable.item_circular_thin_color_white_background)
                holder.tvItem.setTextColor(Color.parseColor("#FF000000"))
            }
            model.getIsCompleted() ->{
                holder.tvItem.background =
                    ContextCompat.getDrawable(holder.itemView.context,
                    R.drawable.item_circular_thin_color_green_background)
